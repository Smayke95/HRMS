...
public class TaskCommentRepository(Context context, IMapper mapper) : BaseRepository<Models.TaskComment, TaskComment, TaskCommentSearch>(context, mapper), ITaskCommentRepository
{
