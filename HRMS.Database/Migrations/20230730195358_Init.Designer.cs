            ...
            modelBuilder.Entity("HRMS.Database.Models.Log", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2023, 7, 30, 21, 53, 58, 468, DateTimeKind.Local).AddTicks(9291),
                            Message = "",
                            Type = "INFO"
                        },
                        new
                        {
                            Id = 2,
                            Date = new DateTime(2023, 7, 30, 21, 53, 58, 468, DateTimeKind.Local).AddTicks(9346),
                            Message = "",
                            Type = "WARNING"
                        },
                        new
                        {
                            Id = 3,
                            Date = new DateTime(2023, 7, 30, 21, 53, 58, 468, DateTimeKind.Local).AddTicks(9349),
                            Message = "",
                            Type = "ERROR"
                        });
                });
            ...
            modelBuilder.Entity("HRMS.Database.Models.TaskComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmployeeId = 1,
                            TaskId = 1,
                            Time = new DateTime(2023, 7, 30, 21, 53, 58, 469, DateTimeKind.Local).AddTicks(427)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            EmployeeId = 2,
                            TaskId = 2,
                            Time = new DateTime(2023, 7, 30, 21, 53, 58, 469, DateTimeKind.Local).AddTicks(432)
                        });
                });
