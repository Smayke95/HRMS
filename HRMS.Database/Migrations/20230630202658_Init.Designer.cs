            ...
            modelBuilder.Entity("HRMS.Database.Models.Log", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2023, 6, 30, 22, 26, 58, 671, DateTimeKind.Local).AddTicks(6758),
                            Message = "",
                            Type = "INFO"
                        },
                        new
                        {
                            Id = 2,
                            Date = new DateTime(2023, 6, 30, 22, 26, 58, 671, DateTimeKind.Local).AddTicks(6813),
                            Message = "",
                            Type = "WARNING"
                        },
                        new
                        {
                            Id = 3,
                            Date = new DateTime(2023, 6, 30, 22, 26, 58, 671, DateTimeKind.Local).AddTicks(6815),
                            Message = "",
                            Type = "ERROR"
                        });
                });
            ...
            modelBuilder.Entity("HRMS.Database.Models.TaskComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmployeeId = 1,
                            TaskId = 1,
                            Time = new DateTime(2023, 6, 30, 22, 26, 58, 671, DateTimeKind.Local).AddTicks(7492)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            EmployeeId = 2,
                            TaskId = 2,
                            Time = new DateTime(2023, 6, 30, 22, 26, 58, 671, DateTimeKind.Local).AddTicks(7500)
                        });
                });
